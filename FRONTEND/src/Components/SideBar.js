        ...
        <div>
            <React.Fragment key="left">
                <Drawer className=" h-screen w-72 sticky top-0" open={state["left"]} onClose={toggleDrawer("left", false)} >
                    <div className="w-full h-full overflow-y-auto py-4 px-3 bg-slate-900 text-white  ">
                        ...
                        <div className="flex cursor-pointer items-center absolute inset-x-2 bottom-8  p-2 text-base font-normal  rounded-lg  hover:bg-gray-100 hover:text-black ">
